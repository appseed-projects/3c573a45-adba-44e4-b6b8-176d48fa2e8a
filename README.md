...
- Timestamp: `2022-07-10 04:39`
- Build ID: `3c573a45-adba-44e4-b6b8-176d48fa2e8a`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3c573a45-adba-44e4-b6b8-176d48fa2e8a.git
$ cd 3c573a45-adba-44e4-b6b8-176d48fa2e8a
```
